...
camera.setPosition(V3f(0.0, 0.25, 5.0))
...
# Save image to disk
#renderer.saveImage("trivial.bmp")
renderer.saveImage("trivial.jpg")
#renderer.saveImage("trivial.png")
#renderer.saveImage("trivial.tiff")
#renderer.saveImage("trivial.exr")
