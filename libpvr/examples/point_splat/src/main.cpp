...
int main()
{
  ...
  buffer->setSize(Imath::V3i(res));
  buffer->clear(Imath::V3f(0.0));

  for (int i = 0; i < numPoints; i++) {
    float x = rng.nextf() * res;
    float y = rng.nextf() * res;
    float z = 0.5;
    writePoint(Vector(x, y, z), Imath::V3f(1.0), buffer);
  }
  ...
  for (int i = 0; i < numPoints; i++) {
    ...
    float y = rng.nextf() * res;
    float z = 0.5;
    writeAntialiasedPoint(Vector(x, y, z), Imath::V3f(1.0), buffer);
  }
  ...
  for (int i = 0; i < numPoints; i++) {
    ...
    writeLine<true>(Vector(x, y, z), Vector(xe, ye, z), Imath::V3f(1.0), buffer);
  }
  ...
  for (int i = 0; i < numPoints; i++) {
    ...
    float y = rng.nextf() * res;
    float z = 0.5;
    writePoint(Vector(x, y, z), Imath::V3f(density), buffer);
  }
  ...
  for (int i = 0; i < numPoints; i++) {
    ...
    float y = rng.nextf() * res;
    float z = 0.5;
    writeAntialiasedPoint(Vector(x, y, z), Imath::V3f(density), buffer);
  }
