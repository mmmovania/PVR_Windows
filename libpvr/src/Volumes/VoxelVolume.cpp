                                 ...
                                 const IntervalVec &intervals) const
{
  ...
  Imath::V3i in = Imath::clip(Imath::V3i(vsStart), m_sparse->extents());
  ...
  // Direction to step
  Imath::V3i sgn(sign(bsRay.dir.x), sign(bsRay.dir.y), sign(bsRay.dir.z));
                                  ...
                                  double &t0, double &t1) const
{
  ...
  box.min = Imath::V3i(block.x * blockSz, block.y * blockSz, block.z * blockSz);
  box.max = box.min + Imath::V3i(blockSz - 1, blockSz - 1, blockSz - 1);
  BBox vsBox(box.min, box.max + Imath::V3i(1)), lsBox;
                                 ...
                                 const IntervalVec &intervals) const
{
  ...
  Imath::V3i in = Imath::clip(Imath::V3i(vsStart), m_sparse->extents());
  Imath::V3i out = Imath::clip(Imath::V3i(vsEnd), m_sparse->extents());

  // Find start and end block
  Imath::V3i bStart, bEnd;
  m_sparse->getBlockCoord(in.x, in.y, in.z, bStart.x, bStart.y, bStart.z);
